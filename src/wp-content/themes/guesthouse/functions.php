...
function theme_init () {
	...
	if (is_admin()) {
		...
		//wp_enqueue_script( 'JS_colorbox', THEME_JS_URL . '/libs/jquery.colorbox.js',  array('jquery') );
...
$pageOptions = array(
	...
	'page_static_text' => new WPAlchemy_MetaBox(array(
		...
		'types' => array('post', 'page', 'ait-room'),
		'context' => 'normal',
		'priority' => 'core',
  ...
  'page_room' => new WPAlchemy_MetaBox(array(
		...
		'types' => array('ait-room', 'page', 'post'),
		'context' => 'normal',
		'priority' => 'core',
